...
public class HangmanController extends WordNerdController {
	...
	public void setupBindings() {
		...
		GameView.wordTimer.timeline.setOnFinished(event -> { 
			...
			String str="0"+" "+hangman.hangmanRound.getPuzzleWord()+" "+(Hangman.HANGMAN_GAME_TIME-Integer.parseInt(GameView.wordTimer.timerButton.getText()))+" "+Float.toString((float)hangman.hangmanRound.getHitCount()/hangman.hangmanRound.getMissCount())+"\n";
